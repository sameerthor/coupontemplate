                    ...
                    <div>
                        <div className="row text-center px-md-5 py-2">
                            <p className="copyright-para mb-2">
                                SuperCosts earns affiliate commisions on qualifying purchases as an
                                amazon associate. "Amazon, and the Amazon logo are trademarks of
